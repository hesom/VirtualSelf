...
//	public AttachmentPointBehaviour Wrist;
	...
	void Update ()
	{
		...
		else if (FirePinch.IsActive) Fire();
...
//		else if (ThumbExtended.IsActive) Load(); // for testing only
		else if (_reloaded && (!ThumbUp.IsActive || !ThumbExtended.IsActive))
		{
